...
- Detailed technical documents for agents and developers live in `docs/agent/`.
- Visual human-facing documents live in `docs/human/`.
...
- [0006. Separate agent docs and human HTML docs](docs/adr/0006-separate-agent-docs-and-human-html-docs.md)
